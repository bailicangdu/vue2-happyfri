<template lang="pug">
div
    div.your_scores_container
        header.your_scores
            span.score_num {{score}}
            span.fenshu 分！
        div.result_tip {{scoreTips}}
    div.share_button(@click="showCover")
    div.share_code
        header.share_header 关注葡萄之家，获取答案。
        img.code_img(src="../../images/4-4.png", height="212", width="212")
    div.share_cover(v-show="showHide", @click="showCover")
        img.share_img(src="../../images/5-2.png")
</template>
